<?php
//This is a copy of \Illuminate\Auth\Notifications\VerifyEmail() which I lifted and modified to satisfy's G's request
...
class CustomVerifyEmail extends Notification
{
    ...
    protected function verificationUrl($notifiable)
    {
        ...
        $customUrl = url("/verify_email"."/".$customToken);
